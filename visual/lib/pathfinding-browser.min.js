            ...
            for (
              ...
              for (
                ...
                if (((h = u[l]), !h.closed)) {
                  ...
                  (c = h),
                    (f = h.y),
                    (d = a.g + (0 === c - a || 0 === f - a.y ? 1 : W)),
                    (!h.opened || d < h.g) &&
                      ((h.g = d),
                      (h.h = h.h || m(F(c - r), F(f - o))),
                      (h.f = h.g + h.h),
                      (h.parent = a),
        ...
        function (t, e) {
          ...
          (r.prototype.findPath = function (t, e, r, n, o) {
            ...
            for (p.push(d), d.opened = !0; p.length; ) {
              ...
              for (s = o.getNeighbors(u, c), h = 0, l = s.length; l > h; ++h)
                (a = s[h]),
                  a.closed ||
                    a.opened ||
