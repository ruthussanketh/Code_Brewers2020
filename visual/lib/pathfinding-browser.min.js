      ...
      function (t, e) {
        ...
        r.prototype.findPath = function (t, e, r, n, o) {
          ...
          for (f.push(p), p.opened = !0, p.by = b, d.push(c), c.opened = !0, c.by = A; f.length && d.length; ) {
            for (u = f.shift(), u.closed = !0, s = o.getNeighbors(u, g), h = 0, l = s.length; l > h; ++h) if (a = s[h], !a.closed) if (a.opened) {
              if (a.by === A) return i.biBacktrace(u, a)
            } else f.push(a),
            a.parent = u,
            a.opened = !0,
            a.by = b;
            for (u = d.shift(), u.closed = !0, s = o.getNeighbors(u, g), h = 0, l = s.length; l > h; ++h) if (a = s[h], !a.closed) if (a.opened) {
      ...
      function (t, e) {
        ...
        r.prototype.findPath = function (t, e, r, n, o) {
          ...
          for (p.push(d), d.opened = !0; p.length; ) {
            ...
            for (s = o.getNeighbors(u, c), h = 0, l = s.length; l > h; ++h) a = s[h],
